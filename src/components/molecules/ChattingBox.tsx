...
import SendButton, { SendButtonMode } from "../atoms/utils/SendButton";
...
export default function ChattingBox(
    ...
    return <div {...props} className={`w-full min-h-[52px] p-[6px] flex gap-[4px] rounded-full bg-background-base ${props.className || ''}`}>
        ...
        <input className="grow min-h-[35px] outline-none py-[8px] text-[16px] font-medium bg-transparent"
